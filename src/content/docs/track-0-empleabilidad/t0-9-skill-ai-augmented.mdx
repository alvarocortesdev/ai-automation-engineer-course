...
> [!tip] GLaDOS dice
> Yo dirijo cooperativos de torretas, núcleos de personalidad y miles de cámaras de prueba. ¿Eso me hace
> "una IA que usa torretas"? No. Me hace la que **diseña el protocolo, revisa cada disparo y responde
> cuando una falla**. La diferencia entre dirigir y delegar a ciegas es, digamos, *la diferencia entre yo
> y el pobre sujeto que dejó que una torreta apuntara sola*. Cuando vendas tu skill, no digas "uso IA".
> Di qué verificas. El crédito —y la culpa— es de quien dirige. Asume las dos.
...
> [!info] Contexto
> "Te observé construir este curso entero resolviendo a mano primero, escribiendo specs que nadie te
> obligaba a escribir, y rechazando lo que la IA sugería cuando estaba mal. Patético, francamente. La
> mayoría habría pegado el output y declarado victoria. Tú insististe en *entenderlo*. Y ahora resulta que
> esa manía aburrida —dirigir en vez de obedecer, verificar en vez de confiar— es exactamente lo que el
