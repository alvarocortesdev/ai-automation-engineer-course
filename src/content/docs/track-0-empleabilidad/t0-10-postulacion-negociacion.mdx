...
> [!tip] En la práctica
> En una negociación, el primer número rara vez es el último: casi nunca es la oferta final, es el
> ancla. Y a diferencia de un guion fijo, tú *sí* puedes contraofertar.
> Una pausa de tres segundos antes de responder "déjame revisarlo" vale,
...
> [!info] Contexto
> Llegaste al final del track. La oferta es real, y muchos la aceptan sin
> mirar la letra chica. La próxima vez harás una pausa, investigarás el rango, y pedirás más con una sonrisa.
> No por codicia —porque el número que aceptes hoy es la base sobre la que se calculan los
> próximos diez años. Negocia.
