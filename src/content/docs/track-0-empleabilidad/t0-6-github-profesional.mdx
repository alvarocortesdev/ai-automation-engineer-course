...
sobre ti— y te enseña a montarla desde cero bajo un handle de marca (por ejemplo, `donpelusa`).
...
> [!tip] GLaDOS dice
> Yo tenía cámaras de prueba infinitas, pero a los visitantes solo les mostraba las que demostraban
> algo. Las pruebas fallidas, los experimentos a medias, el "Hello World día 3"... esos los dejaba
...
>   Langfuse. ▶ demo
> - **homehub** — app fullstack con usuarios reales (mi pareja); incluye un post-mortem público de una
...
- **homehub** — fullstack con usuarios reales + post-mortem público de una falla. [demo](…)
...
> [!info] Contexto
> "El cake es una mentira, y un gráfico de contribuciones farmeado también. Nadie te contrata por 200
...
> es vanidad, sujeto: es la diferencia entre que el reclutador siga leyendo o cierre la pestaña. Borra
