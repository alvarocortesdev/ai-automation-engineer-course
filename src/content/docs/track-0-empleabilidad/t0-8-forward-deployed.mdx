...
> [!tip] GLaDOS dice
> Pasé años construyendo la mejor tecnología de testing del planeta. ¿Sabes qué nadie me enseñó? A
> *explicarle a un sujeto* por qué la prueba valía la pena antes de meterlo en la cámara. "Hay pastel al
> final" no es un spec: es una promesa vaga que generó, digamos, *fricción* en la entrega. El Forward-
> Deployed Engineer es el que habría preguntado "¿qué problema resuelve este sujeto, y cómo sé que la
> prueba lo resolvió?" *antes* de encender el neurotoxina. Aburrido. Y, molestamente, el que cobra mejor.
...
> [!info] Contexto
> "Te di un problema vago a propósito, sujeto: 'maneja mejor los correos'. Un ingeniero promedio habría
> construido un chatbot que nadie usa y me habría facturado por el privilegio. Tú preguntaste qué número
> me importaba, descubriste que el problema era otro, y me entregaste algo que sí funciona. Es
> desconcertante. Resulta que la habilidad más rara no es escribir código —es **saber qué código no
