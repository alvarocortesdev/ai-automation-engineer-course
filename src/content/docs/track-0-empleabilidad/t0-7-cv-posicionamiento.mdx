...
> [!tip] En la práctica
> Hay dos formas de describir lo mismo. Una: "fui responsable de operar el sistema de testing".
> Otra: "reduje el tiempo de testing un 40% reescribiendo la
> suite crítica". ¿Ves la diferencia? La primera describe una **silla** que ocupaste; la otra
> describe el **dato** que dejaste. Tu CV está lleno de sillas que ocupaste. Bórralas. Deja los datos.
...
- Shipped HomeBase, a fullstack app with real users (CI/CD, full UI states),
...
> [!info] Contexto
> Tu CV no debería ser una lista de cargos. La diferencia entre 'fui responsable de cosas' y
> 'reduje X un 70% midiendo Y' es la diferencia entre quien cierra la pestaña y quien agenda la
> llamada. No estás describiendo tu pasado: estás vendiendo tu próximo aporte. Pon un número
