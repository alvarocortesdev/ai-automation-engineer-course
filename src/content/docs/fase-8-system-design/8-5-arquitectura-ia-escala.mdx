...
> [!tip] GLaDOS dice
> Yo coordinaba miles de cámaras de prueba, cada una resolviendo lo suyo. ¿El secreto para no fundir
> el presupuesto de neurotoxina? No mandaba *todo* a la cámara más cara. Las pruebas triviales iban a
> equipo barato; solo lo difícil escalaba al caro. Tú vas a aprender lo mismo con modelos: no le pidas
...
> [!info] Contexto
> "El cake es una mentira, pero esta factura de tokens no. Diséñala bien y ahorrarás miles. Diséñala
