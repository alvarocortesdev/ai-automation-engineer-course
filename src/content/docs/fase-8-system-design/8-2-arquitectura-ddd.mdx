...
- **En 1 semana:** dibuja de memoria el context map de un sistema que conozcas (HomeBase, tu trabajo) con sus 2-3 bounded contexts y marca dónde pondrías un ACL. Si todo te queda en "un solo context", pregúntate si de verdad un término significa lo mismo en todas partes —o si estás forzando un modelo único (sección 4.5).
