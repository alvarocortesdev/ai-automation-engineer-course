...
> [!tip] GLaDOS dice
> Yo gestioné una instalación entera con miles de cámaras de prueba funcionando en paralelo. ¿Sabes
> cuál era el cuello de botella? Nunca el que la gente creía. Siempre asumían "necesitamos más
> potencia" y el problema real era una cola saturada en un punto tonto. Tú vas a aprender a mirar el
> sistema y señalar *dónde* se atasca, no a comprar servidores al azar y rezar. Es más barato. Y a mí
> me gusta lo barato.
