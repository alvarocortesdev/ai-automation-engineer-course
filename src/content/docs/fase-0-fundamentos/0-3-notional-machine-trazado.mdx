...
> [!tip] GLaDOS says
> "Lo leí y entendí" no es un dato verificable. "Lo predije y acerté sin ejecutar" sí. Una de esas dos frases pasa la entrevista. La otra es la mentira que te cuentas — como cierto pastel.
