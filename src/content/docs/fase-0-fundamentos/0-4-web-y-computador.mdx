...
En [0.1 Mentalidad y método](/fase-0-fundamentos/0-1-mentalidad/) acordamos el **Primero-Sin-IA**: intentar a mano antes de pedir ayuda. En [0.3 Trazado a mano](/fase-0-fundamentos/0-3-trazado-a-mano/) entrenaste a **predecir la salida** de un programa sin ejecutarlo. Aquí aplicas lo mismo, pero al sistema completo: vas a **predecir** qué responde un servidor antes de mirar.
