...
- **"Una IP identifica a una persona."** ❌ Gracias a **NAT**, toda tu casa (celular, TV, notebook, el servidor de casa) sale a internet con **una sola IP pública compartida**. La IP identifica una conexión de red, no a un humano.
