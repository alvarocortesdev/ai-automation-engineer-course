...
|---|---|---|
| Escribir la spec antes de codear | [0.8 Spec-first](/fase-0-fundamentos/0-8-spec-first-stack-traces/) | El contrato de entradas/salidas/casos borde |
...
Antes de escribir una sola línea de Python, escribo la mini-spec. Esto es [0.8](/fase-0-fundamentos/0-8-spec-first-stack-traces/) en acción: si no sé qué entra, qué sale y qué puede salir mal, no estoy listo para programar.
...
Enunciado completo, plantillas (`SPEC`, `ADR`, hook, esqueleto) y cómo pedir la corrección: [`ejercicios/fase-0/capstone-cli-sin-ia/`](https://github.com/) (carpeta del repo).
