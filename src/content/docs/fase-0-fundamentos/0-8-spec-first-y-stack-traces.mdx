...
Si ya escribiste specs o llevas tiempo leyendo tracebacks, no te saltes la lección: úsala como **diagnóstico**. Ve directo a los dos retos del final y resuélvelos **sin IA**. Si escribes la mini-spec del divisor de cuenta sin titubear y diagnosticas los tres stack traces a la primera, valida con el check de dominio y pasa al [Capstone F0](/fase-0-fundamentos/proyecto/). Si dudas en algún caso borde o lees el traceback de arriba hacia abajo, vuelve a la sección que falló.
:::
