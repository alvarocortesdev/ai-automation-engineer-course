...
| 0.8 | [Spec-first mínimo + lectura de stack traces](/fase-0-fundamentos/0-8-spec-first-y-stack-traces/) | Escribir la mini-spec (entradas/salidas/casos borde) **antes** de codear; leer y entender errores. |
| 0.P | [🛠️ Capstone — CLI sin IA](/fase-0-fundamentos/proyecto/) | Una herramienta de línea de comandos útil de verdad, escrita 100% sin IA. Tu prueba de autonomía. |
