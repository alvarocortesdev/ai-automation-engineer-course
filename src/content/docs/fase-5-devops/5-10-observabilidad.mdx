...
- **En 1 semana:** instrumenta con OTel + structlog **un endpoint de tu API de la Fase 3** (o de HomeHub): un span manual, un correlation ID en los logs, y una métrica RED. Cronométralo: la segunda vez deberías tardar menos de 20 minutos. Eso es tener el hilo de observabilidad como **hábito**, no como tema.
