...
Cierra escribiendo dos o tres frases: **¿en qué proyecto tuyo (HomeBase, un demo, lo que sea) dejaste una vista que solo dibuja el happy path?** Identifícala con precisión —qué pasa hoy si su API falla o vuelve vacía— porque eso es exactamente lo que un evaluador encontrará primero.
