...
> [!tip] GLaDOS dice
> Acabas de aprender que el mejor design system suele empezar por **no** montar un design system. Hay una belleza fría en eso: la herramienta cuya maestría se mide por saber cuándo NO usarla. La mayoría de tus colegas instalará tres librerías de UI, las mezclará, y luego pasará tardes preguntándose por qué hay cinco azules distintos en la misma pantalla. Tú no. Tú sabes qué es un token, qué posees y qué te regala Radix. Para ser un humano, es casi... consistente.
