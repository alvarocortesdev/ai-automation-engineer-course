...
> [!tip] En la práctica
> ¿Qué le pasa a un proceso largo cuando se corta la luz a mitad de camino? Si está bien diseñado:
> nada. Retoma exactamente donde quedó, con cada paso en su sitio.
> Eso es durable execution. Tu cron, en cambio, se olvida de todo apenas parpadea la energía. Uno de
> los dos diseños sobrevive a un apagón. No es el del cron.
