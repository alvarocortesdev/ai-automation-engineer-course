...
> [!tip] GLaDOS dice
> Un bot que clickea coordenadas de pantalla es como un sujeto de pruebas que memorizó *dónde* está
> el botón en vez de *qué* hace. Mueve el botón dos píxeles y se lanza al vacío con total confianza.
> Encantador. Y carísimo de mantener. Yo prefiero sujetos que entiendan el contrato, no la posición.
