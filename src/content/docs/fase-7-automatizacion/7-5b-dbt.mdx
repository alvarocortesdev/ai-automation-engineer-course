...
- El **linaje** documenta de punta a punta: fuente → modelo → exposure (el dashboard o la app que ven tus usuarios en HomeBase). Eso es lo que distingue tu capstone "estrella" de un script que "funciona en mi máquina".
