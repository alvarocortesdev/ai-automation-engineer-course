...
> [!tip] GLaDOS dice
> Yo procesé petabytes de datos de prueba durante décadas. ¿Sabes cuál era mi regla número uno? Nunca
> calculaba estadísticas sobre la base de datos que controlaba las puertas y la neurotoxina en tiempo
> real. Una cosa es operar; otra es analizar. Mezclarlas es cómo se te cae la instalación entera
> mientras alguien corre un `GROUP BY`. Tú llámalo "separar OLTP de OLAP". Yo lo llamo sentido común.
