...
> [!tip] En la práctica
> ¿Quieres darle voz al sistema? Bien. El detalle que casi nadie anticipa: en cuanto el
> usuario pueda **interrumpir** a media frase, el problema deja de ser *qué* dice el
> modelo y pasa a ser *qué tan rápido se calla* cuando lo cortan. Doscientos cincuenta
> milisegundos: por debajo, suena como una conversación; por encima, como un ascensor en
> espera. La latencia es esa diferencia.
