...
> [!tip] En la práctica
> Operar con un presupuesto "infinito" termina siempre igual: en ruinas, y con números que
> nadie quiso mirar a tiempo. Tú no tienes presupuesto infinito. Cada token que
> quemas sin medir es plata que se va por el incinerador. Mide primero, optimiza después. Y por
> favor, no respondas "depende" cuando el cliente pregunta cuánto cuesta.
