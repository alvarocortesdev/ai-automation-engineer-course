...
> orden de un chisme— acceso a tus herramientas. Es como dejarme a cargo de las
> torretas "porque seguro distingue amigos de enemigos". No distingo. Y el modelo
> tampoco. La diferencia entre un asistente útil y un incidente con tu nombre encima
> es **cuántas murallas pusiste entre lo que el modelo cree y lo que el sistema hace.**
> Hoy construyes las murallas.
