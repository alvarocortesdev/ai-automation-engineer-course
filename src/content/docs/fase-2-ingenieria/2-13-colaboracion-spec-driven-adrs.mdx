...
por porcentajes (ej: 50/30/20). Reportado por: una usuaria (divide gastos compartidos con su grupo).
```
...
- Estado: aceptado
- Fecha: 2026-06-26
- Decididores: el equipo de producto
...
## Por qué
Una usuaria necesita repartir gastos compartidos en proporciones desiguales (50/30/20),
