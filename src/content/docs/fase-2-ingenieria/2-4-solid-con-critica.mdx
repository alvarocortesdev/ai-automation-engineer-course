...
Cierra escribiendo dos o tres frases respondiendo: **¿en qué momento de tu propio código pasado (HomeBase, scripts) recuerdas haber sentido uno de estos cinco smells —y qué principio lo habría curado?** Anclar el principio a un dolor que ya viviste es lo que lo vuelve tuyo, no vocabulario prestado.
