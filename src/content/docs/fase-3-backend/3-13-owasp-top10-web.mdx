...
- De [`0.4` Cómo funciona la web](/fase-0-fundamentos/0-4-web-y-computador/): IPs privadas vs públicas, NAT, puertos, DNS. Eso es exactamente lo que mira un guardia anti-SSRF.
