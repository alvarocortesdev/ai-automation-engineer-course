...
El **Capstone F1 — La misma app, dos lenguajes** te pide construir la misma mini-API (la despensa de HomeHub) en **Python y en TypeScript/Node**. Esta lección es el cimiento del lado JS/TS:
