...
description: Construye una mini-API de despensa (estilo HomeBase) primero en Python y luego en TypeScript/Node, con validación, tests mínimos y una mini-spec compartida. Tu primer material de portafolio bilingüe, mapeado al Definition of Done de la fase.
sidebar:
  order: 99
---
...
Una **API de despensa**: la versión mínima del módulo de inventario de HomeBase.
