...
El **Capstone F1 — La misma app, dos lenguajes** (una mini-API de tu despensa de HomeHub, en Python y en TypeScript) no exige IA. Pero esta lección es el puente que justifica todo lo demás:
...
- Y es tu **rampa a la Pista B**: con este llamado dominado, ya puedes darle a tu HomeHub una primera feature de IA (resumir, clasificar, sugerir) en cuanto quieras —media hora de trabajo, porque la cañería ya la tienes.
