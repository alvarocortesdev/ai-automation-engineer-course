...
| 1.P | [🛠️ Capstone — La misma app, dos lenguajes](/fase-1-lenguajes/proyecto/) | 🟡 intermedio | Una mini-API (la despensa de HomeBase) en Python **y** en TypeScript/Node, con tests mínimos y mini-spec. |
