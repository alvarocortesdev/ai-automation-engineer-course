...
El **Capstone F1 — La misma app, dos lenguajes** es una mini-API de la despensa de HomeBase escrita en Python y en TypeScript. En el lado TypeScript:
