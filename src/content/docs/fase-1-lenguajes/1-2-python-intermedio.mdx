...
El **Capstone F1 — [La misma app, dos lenguajes](/fase-1-lenguajes/proyecto/)** (una mini-API de tu despensa de HomeBase, en Python y luego en TypeScript) usa estas cuatro construcciones de forma natural:
