...
El **Capstone F1 — La misma app, dos lenguajes** te pide construir una mini-API (gestor de la despensa de HomeBase) en Python y luego en TypeScript. El lado Python **arranca exactamente con lo de esta lección**:
