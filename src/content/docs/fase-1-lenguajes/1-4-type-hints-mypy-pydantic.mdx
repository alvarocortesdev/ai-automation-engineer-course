...
Un módulo de la despensa de HomeBase está **sin tipos** y esconde un bug latente: trata un campo opcional como si siempre estuviera. Tu trabajo es **anotarlo entero**, correr `mypy --strict`, y dejar que mypy te muestre el bug — después arreglarlo para que los tests pasen.
...
El **Capstone F1 — La misma app, dos lenguajes** es una mini-API de la despensa de HomeBase escrita en Python y en TypeScript. En el lado Python:
