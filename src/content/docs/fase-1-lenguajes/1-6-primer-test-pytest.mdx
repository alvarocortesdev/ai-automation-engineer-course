...
El **Capstone F1 — La misma app, dos lenguajes** (una mini-API de tu despensa de HomeBase, en Python y TypeScript) exige tests verdes como condición de entrega —no como adorno final:
